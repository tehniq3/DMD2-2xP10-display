...
ver.7 - unsusccesfull to add IR remote for control
ver.8 - changed to 2 displays 
ver.8a - moved clock in the midle of display, for 12-hour format and AM/PM in left side
ver.8b - added temperature in left side for 24-hour format
ver.8c - first number of date moved one step left
ver.8d - added humidity in left side for 24-hour format (few seconds temperature, few seconds humidity, etc)
--------------------------------------------------------------------------------------*/
...
#include <fonts/Font_6x14niqro.h> //-> This font only contains numbers from 0-9. Used only to display time, font downloaded from https://www.youtube.com/watch?v=-WQuz01Ml80
                                  // my custom font: https://github.com/tehniq3/DMD2-P10-display/blob/main/Font_6x14niqro.h
...
{
if (ora1 == 0) 
  if (tip%2 == 0) dmd.drawChar(x,y, ' '); 
      else dmd.drawChar(x,y, ';');
else
{
if (tip%2 == 0) dmd.drawChar(x,y, ' '); 
      else dmd.drawChar(x,y, ';');
...
if (ora2 != ora20)
{
if (tip%2 == 0) dmd.drawChar(x+7,y, ' '); 
      else dmd.drawChar(x+7,y, ';');
...
if (minut1 != minut10)
{
if (tip%2 == 0) dmd.drawChar(x+18,y, ' '); 
      else dmd.drawChar(x+18,y, ';');
dmd.drawChar(x+18,y, 48+minut1);
}
if (minut2 != minut20)
{
if (tip%2 == 0) dmd.drawChar(x+25,y, ' '); 
      else dmd.drawChar(x+25,y, ';');
dmd.drawChar(x+25,y, 48+minut2);
}

if (millis()/1000%2 == 1)
{
dmd.drawLine(x+33,y+2,x+33,y+3);
dmd.drawLine(x+33,y+7,x+33,y+8);
dmd.drawLine(x+33+tip%2,y+2,x+33+tip%2,y+3);
dmd.drawLine(x+33+tip%2,y+7,x+33+tip%2,y+8);
}
else
{
dmd.drawLine(x+33,y+2,x+33,y+3, GRAPHICS_OFF);
dmd.drawLine(x+33,y+7,x+33,y+8, GRAPHICS_OFF);  
dmd.drawLine(x+33+tip%2,y+2,x+33+tip%2,y+3, GRAPHICS_OFF);
dmd.drawLine(x+33+tip%2,y+7,x+33+tip%2,y+8, GRAPHICS_OFF);
}

if (secunda1 != secunda10)
{
if (tip%2 == 0) dmd.drawChar(x+36,y, ' '); 
      else dmd.drawChar(x+36,y, ';');
dmd.drawChar(x+36,y, 48+secunda1);
}
if (secunda2 != secunda20)
{
if (tip%2 == 0) dmd.drawChar(x+43,y, ' '); 
      else dmd.drawChar(x+43,y, ';');
dmd.drawChar(x+43,y, 48+secunda2);
}
...
if (h12%2 != 0)
{
  x = 0;
  y = 2;
  dmd.drawLine(x+1 ,y  ,x+9 ,y  );
  dmd.drawLine(x   ,y+1,x   ,y+7);
  dmd.drawLine(x+10,y+1,x+10,y+7);
  dmd.drawLine(x+1 ,y+8,x+9 ,y+8);
  dmd.setPixel(x+3,y+2);
  dmd.setPixel(x+2,y+3);
  dmd.setPixel(x+3,y+3);
  dmd.setPixel(x+3,y+4); 
  dmd.setPixel(x+3,y+5);
  dmd.setPixel(x+2,y+6);
  dmd.setPixel(x+3,y+6);   
  dmd.setPixel(x+4,y+6);
  dmd.setPixel(x+6,y+2);
  dmd.setPixel(x+7,y+2);
  dmd.setPixel(x+8,y+3);
  dmd.setPixel(x+7,y+4);
  dmd.setPixel(x+6,y+5);
  dmd.setPixel(x+6,y+6);
  dmd.setPixel(x+7,y+6);
  dmd.setPixel(x+8,y+6);
...
if (pm == 0) // -> A
{
  dmd.drawLine(x  ,y+3,x  ,y  , GRAPHICS_OFF);
  dmd.drawLine(x  ,y  ,x+1,y  , GRAPHICS_OFF);
  dmd.drawLine(x+1,y  ,x+2,y+1, GRAPHICS_OFF);
  dmd.drawLine(x+2,y+1,x+1,y+2, GRAPHICS_OFF);
  dmd.drawLine(x  ,y+1,x  ,y+3);
  dmd.drawLine(x  ,y+1,x+1,y  );
  dmd.drawLine(x+1,y  ,x+2,y+1);
  dmd.drawLine(x+2,y+1,x+2,y+3);
  dmd.drawLine(x  ,y+2,x+2,y+2);
}
else         // -> P
{
   x = 1;
   y = 12;
  dmd.drawLine(x  ,y+1,x  ,y+3, GRAPHICS_OFF);
  dmd.drawLine(x  ,y+1,x+1,y  , GRAPHICS_OFF);
  dmd.drawLine(x+1,y  ,x+2,y+1, GRAPHICS_OFF);
  dmd.drawLine(x+2,y+1,x+2,y+3, GRAPHICS_OFF);
  dmd.drawLine(x  ,y+2,x+2,y+2, GRAPHICS_OFF);
  dmd.drawLine(x  ,y+3,x  ,y  );
  dmd.drawLine(x  ,y  ,x+1,y  );
  dmd.drawLine(x+1,y  ,x+2,y+1);
  dmd.drawLine(x+2,y+1,x+1,y+2);
}
  x = 5;
  y = 12;
  dmd.drawLine(x  ,y  ,x  ,y+3);
 // dmd.drawLine(x+1,y+1,x+1,y+1);
  dmd.setPixel(x+1,y+1);
  dmd.drawLine(x+2,y+2,x+2,y+2);
  dmd.drawLine(x+3,y+1,x+3,y+1);
  dmd.drawLine(x+4,y  ,x+4,y+3); 
}
else  // 24-hour format
{
  x = 0;
  ...
  dmd.drawLine(x+10,y+1,x+10,y+7);
  dmd.drawLine(x+1 ,y+8,x+9 ,y+8);
  dmd.setPixel(x+2,y+2);
  dmd.setPixel(x+3,y+2);
  dmd.setPixel(x+4,y+3);
  dmd.setPixel(x+3,y+4);
  dmd.setPixel(x+2,y+5);
  dmd.setPixel(x+2,y+6);
  dmd.setPixel(x+3,y+6);
  dmd.setPixel(x+4,y+6);
  dmd.setPixel(x+6,y+2);
  dmd.setPixel(x+8,y+2);
  dmd.setPixel(x+6,y+3);
  dmd.setPixel(x+8,y+3); 
  dmd.setPixel(x+6,y+4);
  dmd.setPixel(x+7,y+4);
  dmd.setPixel(x+8,y+4);   
  dmd.setPixel(x+8,y+5);
  dmd.setPixel(x+8,y+6);  
  */
...
//   void drawFilledBox(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2, DMDGraphicsMode mode=GRAPHICS_ON);  
  dmd.drawFilledBox(x, y, x+14, y+10, GRAPHICS_OFF);  
  }
...
else
  {
    ...
    dmd.selectFont(Font_6x14);
        if (tz != 0)  
           ...
           dmd.drawChar(x,y, ';');
        dmd.drawChar(x+7,y, 48+tu);
        dmd.drawLine(x+14,13,x+14,14);
        dmd.drawLine(x+15,13,x+15,14);
        dmd.drawChar(x+17,y, 48+ts);
        dmd.drawLine(x+24,3,x+24,4);
        dmd.drawLine(x+25,3,x+25,4);
...
void putnr (byte nr, byte a, byte b)
{
  //dmd.setPixel(a,b,smol[nr][i]/4);
  for (byte i = 0; i < 5; i++) 
  {
   dmd.setPixel(a  ,b+i,smol[nr][i]/4);
   dmd.setPixel(a+1,b+i,smol[nr][i]%4/2);
